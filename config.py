...
# 'Text'     - start in text mode (console only mode) and will answer commands from there.
...
BOT_DATA_DIR = Path().joinpath(Path().absolute(), 'data')
...
BOT_EXTRA_PLUGIN_DIR = Path().joinpath(Path().absolute(), 'plugins')
...
BOT_LOG_FILE = Path().joinpath(Path().absolute(), 'errbot.log')
